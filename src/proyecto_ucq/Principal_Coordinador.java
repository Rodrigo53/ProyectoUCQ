...
public class Principal_Coordinador extends javax.swing.JFrame {
    public Principal_Coordinador() {
    ...
    private void Mn_abc_docentesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Mn_abc_docentesActionPerformed
        // TODO add your handling code here:
        ABC_Usuarios_Coordinador obj = new ABC_Usuarios_Coordinador();
        obj.setVisible(true);
        dispose();
 ...
 Listas obj = new Listas();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Principal_Coordinador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Principal_Coordinador().setVisible(true);
            }
        });
    }
